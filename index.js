...
function showMpesaInstructions() {
    ...
    document.getElementById("donation-text").innerHTML = "To donate via M-Pesa, use +254757073055, Account: Willy.";
}

function showBankDetails() {
    document.getElementById("donation-details").style.display = "block";
    document.getElementById("donation-text").innerHTML = "Airtel Money: +255697489243, Account Name: Joyce";
}

function showCryptoDetails() {
    document.getElementById("donation-details").style.display = "block";
    document.getElementById("donation-text").innerHTML = "Send Bitcoin to: 3FZbgi29cpjq2GjdwV8eyHuJJnkLtktZc5";
}
